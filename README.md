...
```shell
docker pull ghcr.io/spectrocloud/hello-universe:1.0.9
docker run -p 8080:8080 ghcr.io/spectrocloud/hello-universe:1.0.9
```
...
```shell
docker run -p 8080:8080 -e API_URI=http://localhost:3000 ghcr.io/spectrocloud/hello-universe:1.0.9
```
...
```shell
docker run -p 8080:8080 -p 3000:3000  -e SVC_URI="http://myprivate.api.address.example:3000" -e API_URI="http://myloadbalancer.example:3000"  ghcr.io/spectrocloud/hello-universe:1.0.9-proxy
```
